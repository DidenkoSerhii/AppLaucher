    ...
    public void getInfo(long chatId) throws IOException {
        ...
        if(user.getBank().equalsIgnoreCase("Моно")){
            ...
            if(currencies == null) {
                ...
                if(user.getCurrency().equals("USD")){//Вивід для долара
                ...
                } else if(user.getCurrency().equals("EUR")) {//Вивід для евро
                ...
                } else if(user.getCurrency().contains("USD") && user.getCurrency().contains("EUR")) {//Вивід для долара і евро
